...
Which of the following states had the most democratic constitution in the 1780s? <span data-type="list" data-list-type="enumerated" data-number-style="upper-alpha"> <span data-type="item">Pennsylvania</span> <span data-type="item">Massachusetts</span> <span data-type="item">South Carolina</span> <span data-type="item">Maryland</span> </span>
...
<div data-type="exercise">
<div data-type="problem" markdown="1">
Under the Articles of Confederation, what power did the national Confederation Congress have? <span data-type="list" data-list-type="enumerated" data-number-style="upper-alpha"> <span data-type="item">the power to tax</span> <span data-type="item">the power to enforce foreign treaties</span> <span data-type="item">the power to enforce commercial trade agreements</span> <span data-type="item">the power to create land ordinances</span> </span>
