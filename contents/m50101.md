...
Which of the following was *not* a primary method by which the American government dealt with American Indians during the period of western settlement?<span data-type="list" data-list-type="enumerated" data-number-style="upper-alpha"><span data-type="item">relocation</span> <span data-type="item">appeasement</span> <span data-type="item">extermination</span> <span data-type="item">assimilation</span> </span>
...
<div data-type="exercise">
<div data-type="problem" markdown="1">
What did the Last Arrow pageant symbolize?<span data-type="list" data-list-type="enumerated" data-number-style="upper-alpha"><span data-type="item">the continuing fight of the Indians</span> <span data-type="item">the total extermination of the Indians from the West</span> <span data-type="item">the final step in the Americanization process</span> <span data-type="item">the rebellion at Little Bighorn</span> </span>
