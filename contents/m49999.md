...
What was the Middle Passage?<span data-type="list" data-list-type="enumerated" data-number-style="upper-alpha"> <span data-type="item">the fabled sea route from Europe to the Far East</span> <span data-type="item">the land route from Europe to Africa</span> <span data-type="item">the transatlantic journey that African slaves made to America</span> <span data-type="item">the line between the northern and southern colonies</span> </span>
...
<div data-type="exercise">
<div data-type="problem" markdown="1">
Which of the following is *not* an item Europeans introduced to Indians?<span data-type="list" data-list-type="enumerated" data-number-style="upper-alpha"> <span data-type="item">wampum</span> <span data-type="item">glass beads</span> <span data-type="item">copper kettles</span> <span data-type="item">metal tools</span> </span>
