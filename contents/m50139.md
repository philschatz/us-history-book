...
<div data-type="exercise">
<div data-type="problem" markdown="1">
With the Roosevelt Corollary, Roosevelt sought to establish \_\_\_\_\_\_\_\_. <span data-type="list" data-list-type="enumerated" data-number-style="upper-alpha"> <span data-type="item">the consequences for any European nation that involved itself in Latin American affairs</span> <span data-type="item">the right of the United States to involve itself in Latin American affairs whenever necessary</span> <span data-type="item">the idea that Latin America was free and independent from foreign intervention</span> <span data-type="item">the need for further colonization efforts in the Western Hemisphere</span> </span>
