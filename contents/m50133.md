...
Why did the United States express limited interest in overseas expansion in the 1860s and 1870s? <span data-type="list" data-list-type="enumerated" data-number-style="upper-alpha"> <span data-type="item">fear of attacks on their borders</span> <span data-type="item">post-Civil War reconstruction</span> <span data-type="item">the Anti-Imperialist League</span> <span data-type="item">Manifest Destiny</span> </span>
...
<div data-type="exercise">
<div data-type="problem" markdown="1">
Which of the following did Mahan *not* believe was needed to build an American empire? <span data-type="list" data-list-type="enumerated" data-number-style="upper-alpha"> <span data-type="item">a navy</span> <span data-type="item">military bases around the world</span> <span data-type="item">the reopening of the American frontier</span> <span data-type="item">a canal through Central America</span> </span>
