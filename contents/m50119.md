...
Which of the following statements accurately represents Thorstein Veblen’s argument in *The Theory of the Leisure Class*?<span data-type="list" data-list-type="enumerated" data-number-style="upper-alpha"> <span data-type="item">All citizens of an industrial society would rise or fall based on their own innate merits.</span> <span data-type="item">The tenets of naturalism were the only laws through which society should be governed.</span> <span data-type="item">The middle class was overly focused on its own comfort and consumption.</span> <span data-type="item">Land and natural resources should belong equally to all citizens.</span> </span>
...
<div data-type="exercise">
<div data-type="problem" markdown="1">
Which of the following was *not* an element of realism?<span data-type="list" data-list-type="enumerated" data-number-style="upper-alpha"> <span data-type="item">social Darwinism</span> <span data-type="item">instrumentalism</span> <span data-type="item">naturalism</span> <span data-type="item">pragmatism</span> </span>
